...
@NgModule({
  declarations: [MyApp, HomePage, LandingPage, BottlePage, TabsPage, UserHistoryPage, BottleHistoryPage, Reverse],
  imports: [
    BrowserModule,
  ...
  bootstrap: [IonicApp],
  entryComponents: [MyApp, HomePage, LandingPage, BottlePage, TabsPage, UserHistoryPage, BottleHistoryPage],
  providers: [
    GooglePlus,
    StatusBar,
    SplashScreen,
